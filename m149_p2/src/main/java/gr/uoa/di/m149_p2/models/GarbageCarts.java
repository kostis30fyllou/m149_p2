...
public class GarbageCarts extends Request{
    ...
    public GarbageCarts(Date creationDate, String status, Date completionDate, String serviceRequestNumber, String typeOfServiceRequest, String streetAddress, Integer zipCode, BigDecimal x, BigDecimal y, Integer ward, Integer policeDistrict, Integer communityArea, BigDecimal latitude, BigDecimal longitude, String location, Point point, Integer upVotes, Double numberOfCarts, String currentActivity, String mostRecentAction, String ssa) {
