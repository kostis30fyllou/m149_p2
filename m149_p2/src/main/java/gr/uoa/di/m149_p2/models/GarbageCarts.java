...
public class GarbageCarts extends Request{
    ...
    public GarbageCarts(Date creationDate, String status, Date completionDate, String serviceRequestNumber, String typeOfServiceRequest,
                        ...
                        Double numberOfCarts, String currentActivity, String mostRecentAction, String ssa) {
