...
public class AbandonedVehicles extends Request{
    ...
    public AbandonedVehicles(Date creationDate, String status, Date completionDate, String serviceRequestNumber, String typeOfServiceRequest,
                             ...
                             String plate, String model, String color, String currentActivity, String mostRecentAction,
                             Double daysParked, String ssa) {
